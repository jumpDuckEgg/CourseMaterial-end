    ...
    <div class="courseMaterial">
      ...
      <div class="courseMaterial__item">
            ...
            <el-dialog title="选择题" :visible.sync="modifyChoiceVisible" :before-close='resetChoice'>
                <div class="courseMaterial__item"  >
                    <div  class="courseMaterial__item-title">测试名称：<el-input class="courseMaterial__item-input" v-model="choicesData.onlineTest_title"></el-input> </div>
                    ...
                    <div class="submitBtn"> <el-button type="primary" @click="submitOnlineTest">提交</el-button> </div>
                </div>
            </el-dialog>
      </div>
    </div>
