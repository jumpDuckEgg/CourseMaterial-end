    ...
    <div class="commentManager">
        ...
        <div class="box">
            <el-table border :data="comments" style="width: 100%">
                ...
                <el-table-column prop="comment_people" label="评论人" width="130">
                </el-table-column>
                <el-table-column label="评论人头像" width="100">
                ...
                <el-table-column prop="type_id" label="评论类型ID" width="130">
                </el-table-column>
                ...
                <el-table-column prop="comment_content" label="评论内容" width="180">
                </el-table-column>
